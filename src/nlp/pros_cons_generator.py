...
ratios_df = pd.read_excel(input_path / "financial_ratios.xlsx")

analysis_df = pd.read_csv(output_path / "analysis_parsed.csv")
...
roe_df = analysis_df[analysis_df["metric_type"] == "roe"]
...
for _, row in roe_df.iterrows():
    ...
    if row["value_pct"] >= 20:
        ...
        sales_df = analysis_df[analysis_df["metric_type"] == "compounded_sales_growth"]
                ...
                for _, row in profit_df.iterrows():
                    ...
                    if row["value_pct"] >= 20:
                        ...
                        stock_df = analysis_df[
                            analysis_df["metric_type"] == "stock_price_cagr"
                        ]
                        ...
                        for _, row in stock_df.iterrows():
                            ...
                            if row["value_pct"] >= 15:
                                ...
                                pros_df.to_csv(
                                    output_path / "pros_cons_generated.csv", index=False
                                )
                                            ...
                                            if (
                                                ...
                                                for _, row in sales_df.iterrows():
                                                    ...
                                                    if row["value_pct"] < 5:
                                                        ...
                                                        summary_df.to_csv(
                                                            output_path
                                                            / "pros_cons_summary.csv",
                                                            index=False,
                                                        )

                                                        print(
                                                            "pros_cons_summary.csv created successfully."
                                                        )
                                                        ...
                                                        print(
                                                            f"Total Rules Generated : {len(pros_df)}"
                                                        )
                                                        print(
