...
portfolio_df = pd.read_excel(input_path / "recommended_portfolio.xlsx")
...
summary_df = pd.DataFrame(
    {
        "Metric": ["Companies", "Investment", "Average Weight (%)"],
        "Value": [number_of_companies, total_investment, average_weight],
    }
)

summary_df.to_excel(output_path / "portfolio_summary.xlsx", index=False)
